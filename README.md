...
Statflo API
- SDK version: V4.1.77
  - Build date: 2024-12-06T16:23:31.250194Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.77'
}
```
...
* `target/statflo-java-sdk-V4.1.77.jar`
* `target/lib/*.jar`
