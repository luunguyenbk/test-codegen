...
Statflo API
- SDK version: 22.44.566
  - Build date: 2024-12-06T16:42:32.704291Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:22.44.566'
}
```
...
* `target/statflo-java-sdk-22.44.566.jar`
* `target/lib/*.jar`
