...
Statflo API
- SDK version: V444.22.5656
  - Build date: 2024-12-06T16:36:37.659515Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V444.22.5656'
}
```
...
* `target/statflo-java-sdk-V444.22.5656.jar`
* `target/lib/*.jar`
