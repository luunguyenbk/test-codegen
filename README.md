...
Statflo API
- SDK version: V234.565.6767
  - Build date: 2024-12-06T16:41:24.386652Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V234.565.6767'
}
```
...
* `target/statflo-java-sdk-V234.565.6767.jar`
* `target/lib/*.jar`
